...
const ICONS: Record<string, React.ReactNode> = {
  ...
  agents:    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 14a8 8 0 0 1 16 0"/><line x1="12" y1="14" x2="12" y2="22"/><circle cx="12" cy="4" r="2"/><line x1="12" y1="6" x2="12" y2="10"/><circle cx="12" cy="13" r="2"/></svg>,
...
const ROUTE_CHIP: Record<string, { color: string; bg: string }> = {
  ...
  agents:    { color: '#818cf8', bg: 'rgba(129,140,248,0.20)' },
...
export default function DDIVaultApp() {
  ...
  const visibleItems = useMemo(() => SIDEBAR_ITEMS.filter(item => {
    ...
    if (item.id === 'agents')   return canWrite; // admin+ only — infra config surface
    return true;
