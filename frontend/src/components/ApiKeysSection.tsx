...
function CreateModal({ onClose, onCreated }: CreateModalProps) {
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, background: 'rgba(15,23,42,0.55)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000 }} onClick={onClose}>
      <div style={{ background: 'var(--bg-card)', borderRadius: 'var(--radius)', boxShadow: 'var(--shadow-md)', padding: 24, width: 480, maxWidth: '92%', maxHeight: '90vh', overflow: 'auto' }} onClick={e => e.stopPropagation()}>
